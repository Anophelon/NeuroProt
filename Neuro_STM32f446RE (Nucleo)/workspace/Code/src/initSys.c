...
void InitRCC(void){
	...
	RCC->CFGR &= ~RCC_PLLCFGR_PLLSRC & 													//Clean PLLCFGR & PLLSRC=0 => HSI clock selected
				 ~RCC_PLLCFGR_PLLM 	 &
				 ~RCC_PLLCFGR_PLLN 	 &
				 ~RCC_PLLCFGR_PLLP	 &
				 ~RCC_PLLCFGR_PLLR;

	RCC->CFGR |= RCC_PLLCFGR_PLLSRC_HSI | 												// source HSI = 16MHz
				 RCC_PLLCFGR_PLLM_3 	| 												// DIV_M: source HSI/8 = 2 MHz
				 RCC_PLLCFGR_PLLN_4		|												// clock = 2 MHz * 120 = 240 MHz
				 RCC_PLLCFGR_PLLN_5 	|
				 RCC_PLLCFGR_PLLN_6 	|
				 RCC_PLLCFGR_PLLN_7 	|
